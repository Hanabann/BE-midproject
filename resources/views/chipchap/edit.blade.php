...
<body class="container mt-4">
    ...
    {{-- edit data karyawan --}}
    <form method="post" action="{{route('karyawan.update', ['karyawan' => $karyawan])}}">
        @csrf
        @method('put')
        <div class="mt-3 mb-3">
            <label class="form-label">Nama Karyawan</label>
            <input type="text" name="name" class="form-control" placeholder="5 - 20 karakter" value="{{$karyawan->name}}">
        </div>

        <div class="mb-3">
            <label class="form-label">Umur Karyawan</label>
            <input type="integer" name="umur" class="form-control" placeholder="> 20 tahun" value="{{$karyawan->umur}}">
        </div>

        <div class="mb-3">
            <label class="form-label">Alamat Karyawan</label>
            <input type ="text" name="alamat" class="form-control" placeholder="10 - 40 karakter" value="{{$karyawan->alamat}}">
        </div>

        <div class="mb-3">
            <label class="form-label">No telp. Karyawan</label>
            <input type="numeric" name="telp" class="form-control" placeholder="9 - 12 karakter" value="{{$karyawan->telp}}">
        </div>
