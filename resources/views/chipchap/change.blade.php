    ...
    <div>
        ...
        <thead>
            <tr>
                ...
                <th class="text-center" style="width: 155px;">Update Karyawan</th>
        ...
        @foreach($karyawans as $karyawan)
            ...
            <tr>
                ...
                <td class="text-center align-middle">
                    <a href="{{ route('karyawan.edit', ['karyawan' => $karyawan])}}" class="btn btn-primary btn-sm">Update</a>
                </td>
